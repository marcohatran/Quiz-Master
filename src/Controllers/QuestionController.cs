...
namespace TracNghiem.Model {
    public class QuestionController {
        public QuestionController(int id, int idSubject, string content, string contentA, string contentB, string contentC, string contentD, char answer) {
            this.Id = id;
        ...
        public QuestionController(DataRow row) {
            this.Id = (int)row["id"];
