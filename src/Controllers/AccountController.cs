...
namespace TracNghiem.Model {
    public class AccountController {
        public AccountController(string userName, string displayName, string password, int type, int totalAnsint, int correctAns, int wrongAns, float point, string ranking) {
        ...
        public AccountController(DataRow row) {
    ...
    public class AccountEvent : EventArgs {
        ...
        public AccountEvent(AccountController acc) {
            this.Acc = acc;
        }
    }
}
